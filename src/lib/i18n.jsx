...
export const STRINGS = {
  ...
  "actualizar.titulo":  { es: "Nueva versión disponible", en: "New version available", fr: "Nouvelle version disponible", it: "Nuova versione disponibile", pt: "Nova versão disponível" },
  "actualizar.sub":     { es: "Actualiza desde GitHub para tener las últimas mejoras.", en: "Update from GitHub to get the latest improvements.", fr: "Mets à jour depuis GitHub pour les dernières améliorations.", it: "Aggiorna da GitHub per le ultime novità.", pt: "Atualiza a partir do GitHub para teres as últimas melhorias." },
  "actualizar.boton":   { es: "Actualizar", en: "Update", fr: "Mettre à jour", it: "Aggiorna", pt: "Atualizar" },
  "actualizar.cerrar":  { es: "Cerrar aviso", en: "Dismiss", fr: "Fermer", it: "Chiudi", pt: "Fechar" },
  ...
  // ── Tipos de comida ──
  "comida.tipo_label":   { es: "¿Qué comida es?", en: "Which meal is it?", fr: "Quel repas est-ce ?", it: "Che pasto è?", pt: "Que refeição é?" },
  "comida.tipo.desayuno":{ es: "Desayuno", en: "Breakfast", fr: "Petit-déj", it: "Colazione", pt: "Pequeno-almoço" },
  "comida.tipo.comida":  { es: "Comida", en: "Lunch", fr: "Déjeuner", it: "Pranzo", pt: "Almoço" },
  "comida.tipo.merienda":{ es: "Merienda", en: "Snack", fr: "Goûter", it: "Merenda", pt: "Lanche" },
  "comida.tipo.cena":    { es: "Cena", en: "Dinner", fr: "Dîner", it: "Cena", pt: "Jantar" },
  "comida.tipo.postre":  { es: "Postre", en: "Dessert", fr: "Dessert", it: "Dolce", pt: "Sobremesa" },

  // ── Comidas frecuentes (se añaden solas cada día) ──
  "fijas.titulo":        { es: "Comidas frecuentes", en: "Frequent meals", fr: "Repas fréquents", it: "Pasti frequenti", pt: "Refeições frequentes" },
  "fijas.sub":           { es: "Define tu comida de siempre en cada franja (p. ej. tu desayuno) y la app la añadirá sola cada día, a la hora de inicio de su franja. Sin gastar IA.", en: "Set your usual meal for each time slot (e.g. your breakfast) and the app will add it automatically every day, at the start of its slot. No AI used.", fr: "Définis ton repas habituel pour chaque créneau (p. ex. ton petit-déj) et l'appli l'ajoutera automatiquement chaque jour, au début du créneau. Sans IA.", it: "Definisci il tuo pasto abituale per ogni fascia (es. la colazione) e l'app lo aggiungerà da sola ogni giorno, all'inizio della fascia. Senza IA.", pt: "Define a tua refeição habitual em cada faixa (p. ex. o pequeno-almoço) e a app adiciona-a sozinha todos os dias, no início da faixa. Sem gastar IA." },
  "frec.slot.desayuno":       { es: "Desayuno", en: "Breakfast", fr: "Petit-déjeuner", it: "Colazione", pt: "Pequeno-almoço" },
  "frec.slot.merienda_manana":{ es: "Merienda de mañana", en: "Mid-morning snack", fr: "Collation du matin", it: "Spuntino mattutino", pt: "Lanche da manhã" },
  "frec.slot.comida":         { es: "Comida", en: "Lunch", fr: "Déjeuner", it: "Pranzo", pt: "Almoço" },
  "frec.slot.merienda_tarde": { es: "Merienda de tarde", en: "Afternoon snack", fr: "Goûter", it: "Merenda", pt: "Lanche da tarde" },
  "frec.slot.cena":           { es: "Cena", en: "Dinner", fr: "Dîner", it: "Cena", pt: "Jantar" },
  "fijas.sin_config":    { es: "Sin configurar", en: "Not set", fr: "Non défini", it: "Non impostato", pt: "Não configurado" },
  "fijas.configurar":    { es: "Configurar", en: "Set up", fr: "Configurer", it: "Configura", pt: "Configurar" },
  "fijas.editar":        { es: "Editar", en: "Edit", fr: "Modifier", it: "Modifica", pt: "Editar" },
  "fijas.quitar":        { es: "Quitar comida fija", en: "Remove saved meal", fr: "Retirer le repas fixe", it: "Rimuovi pasto fisso", pt: "Remover refeição fixa" },
  "fijas.ia_titulo":     { es: "Rellenar con IA (foto o texto)", en: "Fill in with AI (photo or text)", fr: "Remplir avec l'IA (photo ou texte)", it: "Compila con l'IA (foto o testo)", pt: "Preencher com IA (foto ou texto)" },
  "fijas.ia_ph":         { es: "Describe la comida (o añade una foto) y la IA calcula los macros…", en: "Describe the meal (or add a photo) and AI will work out the macros…", fr: "Décris le repas (ou ajoute une photo) et l'IA calcule les macros…", it: "Descrivi il pasto (o aggiungi una foto) e l'IA calcola i macro…", pt: "Descreve a refeição (ou adiciona uma foto) e a IA calcula os macros…" },
  "fijas.ia_analizar":   { es: "Analizar", en: "Analyze", fr: "Analyser", it: "Analizza", pt: "Analisar" },
  "fijas.ia_analizando": { es: "Analizando…", en: "Analyzing…", fr: "Analyse…", it: "Analisi…", pt: "A analisar…" },
  "fijas.ia_err":        { es: "No se pudo analizar. Inténtalo de nuevo.", en: "Couldn't analyze. Try again.", fr: "Analyse impossible. Réessaie.", it: "Impossibile analizzare. Riprova.", pt: "Não foi possível analisar. Tenta de novo." },
  "fijas.nombre":        { es: "Nombre de la comida", en: "Meal name", fr: "Nom du repas", it: "Nome del pasto", pt: "Nome da refeição" },
  "fijas.nombre_ph":     { es: "Ej. Tostadas con aguacate y café", en: "e.g. Avocado toast and coffee", fr: "Ex. Toast avocat et café", it: "Es. Toast con avocado e caffè", pt: "Ex. Tostas com abacate e café" },
  "fijas.kcal":          { es: "kcal", en: "kcal", fr: "kcal", it: "kcal", pt: "kcal" },
  "fijas.guardar":       { es: "Guardar", en: "Save", fr: "Enregistrer", it: "Salva", pt: "Guardar" },
  "fijas.cancelar":      { es: "Cancelar", en: "Cancel", fr: "Annuler", it: "Annulla", pt: "Cancelar" },
  "fijas.borrar_confirm":{ es: "¿Quitar esta comida fija?", en: "Remove this saved meal?", fr: "Retirer ce repas fixe ?", it: "Rimuovere questo pasto fisso?", pt: "Remover esta refeição fixa?" },
  "fijas.rapido":        { es: "Añadir rápido", en: "Quick add", fr: "Ajout rapide", it: "Aggiunta rapida", pt: "Adição rápida" },
  "fijas.gestionar":     { es: "Gestionar", en: "Manage", fr: "Gérer", it: "Gestisci", pt: "Gerir" },
  "fijas.crear_primera": { es: "Crear una comida fija", en: "Create a saved meal", fr: "Créer un repas fixe", it: "Crea un pasto fisso", pt: "Criar uma refeição fixa" },
  ...
  "cuenta.privacidad":   { es: "Todo se guarda solo en tu dispositivo. Guarda el archivo exportado en un sitio privado, sobre todo si incluyes tus claves de API.", en: "Everything is stored only on your device. Keep the exported file private, especially if you include your API keys.", fr: "Tout est stocké uniquement sur ton appareil. Garde le fichier exporté privé, surtout si tu inclus tes clés API.", it: "Tutto è salvato solo sul tuo dispositivo. Tieni privato il file esportato, soprattutto se includi le tue chiavi API.", pt: "Tudo é guardado só no teu dispositivo. Mantém o ficheiro exportado privado, sobretudo se incluíres as tuas chaves de API." },
  "cuenta.que_exportar":     { es: "¿Qué quieres exportar?", en: "What do you want to export?", fr: "Que veux-tu exporter ?", it: "Cosa vuoi esportare?", pt: "O que queres exportar?" },
  "cuenta.cat.perfil":       { es: "Perfil y objetivos", en: "Profile and goals", fr: "Profil et objectifs", it: "Profilo e obiettivi", pt: "Perfil e objetivos" },
  "cuenta.cat.perfil.sub":   { es: "Tus datos y tus objetivos nutricionales", en: "Your data and nutrition goals", fr: "Tes données et objectifs nutritionnels", it: "I tuoi dati e obiettivi nutrizionali", pt: "Os teus dados e objetivos nutricionais" },
  "cuenta.cat.comidas":      { es: "Historial de comidas", en: "Meal history", fr: "Historique des repas", it: "Cronologia dei pasti", pt: "Histórico de refeições" },
  "cuenta.cat.comidas.sub":  { es: "Las comidas que has registrado", en: "The meals you've logged", fr: "Les repas que tu as enregistrés", it: "I pasti che hai registrato", pt: "As refeições que registaste" },
  "cuenta.cat.entrenador":     { es: "Entrenador personal", en: "Personal coach", fr: "Coach personnel", it: "Coach personale", pt: "Treinador pessoal" },
  "cuenta.cat.entrenador.sub": { es: "Tu chat y lo que ha aprendido de ti", en: "Your chat and what it learned about you", fr: "Ton chat et ce qu'il a appris sur toi", it: "La tua chat e ciò che ha imparato su di te", pt: "O teu chat e o que aprendeu sobre ti" },
  "cuenta.cat.ajustes":      { es: "Ajustes", en: "Settings", fr: "Réglages", it: "Impostazioni", pt: "Definições" },
  "cuenta.cat.ajustes.sub":  { es: "Idioma, notificaciones, modelo e icono", en: "Language, notifications, model and icon", fr: "Langue, notifications, modèle et icône", it: "Lingua, notifiche, modello e icona", pt: "Idioma, notificações, modelo e ícone" },
  "cuenta.cat.claves":       { es: "Claves de API", en: "API keys", fr: "Clés API", it: "Chiavi API", pt: "Chaves de API" },
  "cuenta.cat.claves.sub":   { es: "Tus claves de Gemini (dato sensible)", en: "Your Gemini keys (sensitive)", fr: "Tes clés Gemini (donnée sensible)", it: "Le tue chiavi Gemini (dato sensibile)", pt: "As tuas chaves Gemini (dado sensível)" },
  "cuenta.cat.claves_aviso": { es: "Cualquiera con este archivo podría usar tus claves y consumir tu cuota de Google. Inclúyelas solo si el archivo se queda contigo.", en: "Anyone with this file could use your keys and spend your Google quota. Only include them if the file stays with you.", fr: "Quiconque a ce fichier pourrait utiliser tes clés et consommer ton quota Google. Ne les inclus que si le fichier reste avec toi.", it: "Chiunque abbia questo file potrebbe usare le tue chiavi e consumare la tua quota Google. Includile solo se il file resta con te.", pt: "Qualquer pessoa com este ficheiro poderia usar as tuas chaves e gastar a tua quota Google. Inclui-as apenas se o ficheiro ficar contigo." },
  ...
  "ajustes.modelo_activo": { es: "Modelo activo", en: "Active model", fr: "Modèle actif", it: "Modello attivo", pt: "Modelo ativo" },
  ...
  // ── Resumen diario del entrenador (notificación) ──
  "notif.coach.titulo":    { es: "Tu entrenador tiene algo que decirte", en: "Your coach has something to tell you", fr: "Ton coach a quelque chose à te dire", it: "Il tuo coach ha qualcosa da dirti", pt: "O teu treinador tem algo para te dizer" },
  "notif.coach.cuerpo":    { es: "Tiene el resumen de tu día listo para ti.", en: "Your daily summary is ready for you.", fr: "Ton résumé du jour est prêt.", it: "Il riepilogo della tua giornata è pronto.", pt: "O resumo do teu dia está pronto." },
  "notif.coach.boton":     { es: "Ver resumen", en: "See summary", fr: "Voir le résumé", it: "Vedi riepilogo", pt: "Ver resumo" },
  "notif.coach_seccion":   { es: "Resumen diario del entrenador", en: "Coach's daily summary", fr: "Résumé quotidien du coach", it: "Riepilogo giornaliero del coach", pt: "Resumo diário do treinador" },
  "notif.coach_sub":       { es: "Cada día, a la hora que elijas, tu entrenador te avisa para hacer un resumen honesto de tu jornada. El resumen se genera al abrir el chat.", en: "Every day, at the time you choose, your coach pings you to give an honest recap of your day. The summary is generated when you open the chat.", fr: "Chaque jour, à l'heure que tu choisis, ton coach te prévient pour faire un bilan honnête de ta journée. Le résumé est généré à l'ouverture du chat.", it: "Ogni giorno, all'ora che scegli, il tuo coach ti avvisa per un resoconto onesto della tua giornata. Il riepilogo si genera aprendo la chat.", pt: "Todos os dias, à hora que escolheres, o teu treinador avisa-te para fazer um resumo honesto do teu dia. O resumo é gerado ao abrir o chat." },
  "notif.coach_activar":   { es: "Resumen diario", en: "Daily summary", fr: "Résumé quotidien", it: "Riepilogo giornaliero", pt: "Resumo diário" },
  "notif.coach_hora":      { es: "¿A qué hora quieres el aviso?", en: "What time do you want the reminder?", fr: "À quelle heure veux-tu le rappel ?", it: "A che ora vuoi l'avviso?", pt: "A que horas queres o aviso?" },
  "notif.coach_guardar":   { es: "Guardar hora", en: "Save time", fr: "Enregistrer l'heure", it: "Salva ora", pt: "Guardar hora" },
  ...
  "hist.1_0_1.titulo":     { es: "Ajustes", en: "Tweaks", fr: "Ajustements", it: "Ritocchi", pt: "Ajustes" },
  "hist.1_0_1.cuerpo": {
    es: "• La fecha de nacimiento se escribe con salto automático entre día, mes y año.\n• Nuevo apartado de Donaciones (PayPal) para apoyar el proyecto.",
    en: "• The date of birth now auto-advances between day, month and year as you type.\n• New Donations section (PayPal) to support the project.",
    fr: "• La date de naissance passe automatiquement du jour au mois puis à l'année pendant la saisie.\n• Nouvelle section Dons (PayPal) pour soutenir le projet.",
    it: "• La data di nascita passa in automatico tra giorno, mese e anno mentre scrivi.\n• Nuova sezione Donazioni (PayPal) per sostenere il progetto.",
    pt: "• A data de nascimento avança automaticamente entre dia, mês e ano enquanto escreves.\n• Nova secção de Donativos (PayPal) para apoiar o projeto.",
  },
  "hist.1_1_0.titulo":     { es: "Entrenador personal IA", en: "AI personal coach", fr: "Coach personnel IA", it: "Coach personale IA", pt: "Treinador pessoal IA" },
  "hist.1_1_0.cuerpo": {
    es: "• Nuevo Entrenador personal: chatea con él sobre tu día y tu alimentación.\n• Aprende de ti: recuerda tus preferencias y hábitos entre conversaciones.\n• Resumen diario automático de cómo ha ido el día.\n• Copia de seguridad selectiva: elige qué exportar e importar.",
    en: "• New personal Coach: chat with it about your day and your eating.\n• It learns from you: it remembers your preferences and habits across conversations.\n• Automatic daily summary of how your day went.\n• Selective backup: choose what to export and import.",
    fr: "• Nouveau Coach personnel : discute avec lui de ta journée et de ton alimentation.\n• Il apprend de toi : il retient tes préférences et habitudes d'une conversation à l'autre.\n• Résumé quotidien automatique de ta journée.\n• Sauvegarde sélective : choisis ce que tu exportes et importes.",
    it: "• Nuovo Coach personale: chatta con lui sulla tua giornata e la tua alimentazione.\n• Impara da te: ricorda le tue preferenze e abitudini tra le conversazioni.\n• Riepilogo giornaliero automatico di com'è andata la giornata.\n• Backup selettivo: scegli cosa esportare e importare.",
    pt: "• Novo Treinador pessoal: conversa com ele sobre o teu dia e a tua alimentação.\n• Aprende contigo: lembra-se das tuas preferências e hábitos entre conversas.\n• Resumo diário automático de como correu o dia.\n• Cópia de segurança seletiva: escolhe o que exportar e importar.",
  },
  "hist.1_2_0.titulo":     { es: "Navegación y notificaciones", en: "Navigation and notifications", fr: "Navigation et notifications", it: "Navigazione e notifiche", pt: "Navegação e notificações" },
  "hist.1_2_0.cuerpo": {
    es: "• Menú lateral (☰) para moverte por la app; se quitó el engranaje.\n• Bandeja de Notificaciones del entrenador (✉️) con tus resúmenes, solo lectura.\n• Chat separado de las notificaciones: varias conversaciones en una lista, con «Nueva conversación».\n• Las notificaciones traen botón para ir directo al chat.",
    en: "• Side menu (☰) to move around the app; the gear icon is gone.\n• Coach Notifications inbox (✉️) with your summaries, read-only.\n• Chat separated from notifications: several conversations in a list, with \"New conversation\".\n• Notifications include a button to jump straight to the chat.",
    fr: "• Menu latéral (☰) pour naviguer dans l'app ; l'engrenage a disparu.\n• Boîte de Notifications du coach (✉️) avec tes résumés, en lecture seule.\n• Chat séparé des notifications : plusieurs conversations dans une liste, avec « Nouvelle conversation ».\n• Les notifications incluent un bouton pour aller directement au chat.",
    it: "• Menu laterale (☰) per muoverti nell'app; l'ingranaggio è stato rimosso.\n• Casella Notifiche del coach (✉️) con i tuoi riepiloghi, in sola lettura.\n• Chat separata dalle notifiche: più conversazioni in un elenco, con «Nuova conversazione».\n• Le notifiche includono un pulsante per andare direttamente alla chat.",
    pt: "• Menu lateral (☰) para te moveres pela app; o ícone de engrenagem foi removido.\n• Caixa de Notificações do treinador (✉️) com os teus resumos, só leitura.\n• Chat separado das notificações: várias conversas numa lista, com «Nova conversa».\n• As notificações trazem um botão para ir direto ao chat.",
  },
  "hist.1_3_0.titulo":     { es: "Comidas frecuentes y tipos de comida", en: "Frequent meals and meal types", fr: "Repas fréquents et types de repas", it: "Pasti frequenti e tipi di pasto", pt: "Refeições frequentes e tipos de refeição" },
  "hist.1_3_0.cuerpo": {
    es: "• Al registrar, elige el tipo: desayuno, comida, merienda, cena o postre.\n• Comidas frecuentes: configura las que repites y se añaden solas cada día en su franja horaria.\n• Las comidas frecuentes también se rellenan con IA (foto o texto).",
    en: "• When logging, pick the type: breakfast, lunch, snack, dinner or dessert.\n• Frequent meals: set up the ones you repeat and they're added automatically each day in their time slot.\n• Frequent meals can also be filled in with AI (photo or text).",
    fr: "• Lors de l'enregistrement, choisis le type : petit-déjeuner, déjeuner, goûter, dîner ou dessert.\n• Repas fréquents : configure ceux que tu répètes et ils s'ajoutent seuls chaque jour dans leur créneau horaire.\n• Les repas fréquents se remplissent aussi avec l'IA (photo ou texte).",
    it: "• Quando registri, scegli il tipo: colazione, pranzo, merenda, cena o dessert.\n• Pasti frequenti: imposta quelli che ripeti e vengono aggiunti da soli ogni giorno nella loro fascia oraria.\n• I pasti frequenti si compilano anche con l'IA (foto o testo).",
    pt: "• Ao registar, escolhe o tipo: pequeno-almoço, almoço, lanche, jantar ou sobremesa.\n• Refeições frequentes: configura as que repetes e são adicionadas sozinhas todos os dias na sua faixa horária.\n• As refeições frequentes também se preenchem com IA (foto ou texto).",
  },
  "hist.1_4_0.titulo":     { es: "Entrenador por día y modelo automático", en: "Per-day coach and automatic model", fr: "Coach par jour et modèle automatique", it: "Coach per giornata e modello automatico", pt: "Treinador por dia e modelo automático" },
  "hist.1_4_0.cuerpo": {
    es: "• Botón «Hablar con tu entrenador sobre el día» en cada resumen.\n• El modelo de IA se actualiza solo al recomendado; ya no hay que elegirlo a mano.",
    en: "• \"Talk to your coach about the day\" button on every summary.\n• The AI model updates itself to the recommended one; no need to pick it manually.",
    fr: "• Bouton « Parler de ta journée avec ton coach » sur chaque résumé.\n• Le modèle d'IA se met à jour tout seul vers celui recommandé ; plus besoin de le choisir à la main.",
    it: "• Pulsante «Parla con il tuo coach della giornata» in ogni riepilogo.\n• Il modello di IA si aggiorna da solo a quello consigliato; non serve più sceglierlo a mano.",
    pt: "• Botão «Falar com o teu treinador sobre o dia» em cada resumo.\n• O modelo de IA atualiza-se sozinho para o recomendado; já não é preciso escolhê-lo à mão.",
  },
  "hist.1_4_1.titulo":     { es: "Correcciones", en: "Fixes", fr: "Corrections", it: "Correzioni", pt: "Correções" },
  "hist.1_4_1.cuerpo": {
    es: "• Arreglado: una comida frecuente se añadía al día en curso en vez de esperar a su franja.\n• Arreglado: error al analizar algunas comidas.\n• Arreglado: tamaño y encuadre del botón «Analizar».",
    en: "• Fixed: a frequent meal was added to the current day instead of waiting for its time slot.\n• Fixed: an error when analyzing some meals.\n• Fixed: size and alignment of the \"Analyze\" button.",
    fr: "• Corrigé : un repas fréquent s'ajoutait au jour en cours au lieu d'attendre son créneau.\n• Corrigé : une erreur lors de l'analyse de certains repas.\n• Corrigé : la taille et le cadrage du bouton « Analyser ».",
    it: "• Corretto: un pasto frequente veniva aggiunto al giorno corrente invece di attendere la sua fascia.\n• Corretto: un errore nell'analisi di alcuni pasti.\n• Corretto: dimensione e allineamento del pulsante «Analizza».",
    pt: "• Corrigido: uma refeição frequente era adicionada ao dia atual em vez de esperar pela sua faixa.\n• Corrigido: um erro ao analisar algumas refeições.\n• Corrigido: tamanho e enquadramento do botão «Analisar».",
  },
  "hist.1_5_0.titulo":     { es: "Gemini 3.7 y avisos de actualización", en: "Gemini 3.7 and update alerts", fr: "Gemini 3.7 et alertes de mise à jour", it: "Gemini 3.7 e avvisi di aggiornamento", pt: "Gemini 3.7 e avisos de atualização" },
  "hist.1_5_0.cuerpo": {
    es: "• Nuevo modelo Gemini 3.7 Flash por defecto (más rápido y preciso).\n• Aviso dentro de la app cuando haya una nueva versión, con enlace para actualizar.",
    en: "• New Gemini 3.7 Flash model by default (faster and more accurate).\n• In-app alert when a new version is available, with a link to update.",
    fr: "• Nouveau modèle Gemini 3.7 Flash par défaut (plus rapide et plus précis).\n• Alerte dans l'app quand une nouvelle version est disponible, avec un lien pour mettre à jour.",
    it: "• Nuovo modello Gemini 3.7 Flash predefinito (più veloce e preciso).\n• Avviso nell'app quando è disponibile una nuova versione, con link per aggiornare.",
    pt: "• Novo modelo Gemini 3.7 Flash por defeito (mais rápido e preciso).\n• Aviso dentro da app quando houver uma nova versão, com ligação para atualizar.",
  },
  ...
  "conexion.modelo_ph":    { es: "ID del modelo, p. ej. gemini-3.6-flash", en: "Model ID, e.g. gemini-3.6-flash", fr: "ID du modèle, p. ex. gemini-3.6-flash", it: "ID del modello, es. gemini-3.6-flash", pt: "ID do modelo, p. ex. gemini-3.6-flash" },
  ...
  "conexion.anadir_clave": { es: "Añadir clave", en: "Add key", fr: "Ajouter une clé", it: "Aggiungi chiave", pt: "Adicionar chave" },
  "conexion.anadir_otra":  { es: "Añadir otra clave", en: "Add another key", fr: "Ajouter une autre clé", it: "Aggiungi un'altra chiave", pt: "Adicionar outra chave" },
  "conexion.claves_titulo":{ es: "Tus claves", en: "Your keys", fr: "Tes clés", it: "Le tue chiavi", pt: "As tuas chaves" },
  "conexion.claves_nota":  { es: "Puedes añadir varias claves. Si una se queda sin tokens, la app pasa sola a otra con cuota disponible.", en: "You can add several keys. If one runs out of tokens, the app switches to another with available quota.", fr: "Tu peux ajouter plusieurs clés. Si l'une manque de jetons, l'appli passe à une autre avec du quota disponible.", it: "Puoi aggiungere più chiavi. Se una finisce i token, l'app passa a un'altra con quota disponibile.", pt: "Podes adicionar várias chaves. Se uma ficar sem tokens, a app passa a outra com quota disponível." },
  "conexion.sin_claves":   { es: "Aún no has añadido ninguna clave.", en: "You haven't added any keys yet.", fr: "Tu n'as encore ajouté aucune clé.", it: "Non hai ancora aggiunto nessuna chiave.", pt: "Ainda não adicionaste nenhuma chave." },
  "conexion.quitar":       { es: "Quitar clave", en: "Remove key", fr: "Retirer la clé", it: "Rimuovi chiave", pt: "Remover chave" },
  "conexion.clave_anadida":{ es: "Clave añadida y validada. ✅", en: "Key added and validated. ✅", fr: "Clé ajoutée et validée. ✅", it: "Chiave aggiunta e convalidata. ✅", pt: "Chave adicionada e validada. ✅" },
  "conexion.modelo_guardado":{ es: "Modelo guardado.", en: "Model saved.", fr: "Modèle enregistré.", it: "Modello salvato.", pt: "Modelo guardado." },
  "conexion.estado.activa":  { es: "Activa", en: "Active", fr: "Active", it: "Attiva", pt: "Ativa" },
  "conexion.estado.agotada": { es: "Sin tokens", en: "Out of tokens", fr: "Sans jetons", it: "Senza token", pt: "Sem tokens" },
  "conexion.estado.invalida":{ es: "Inválida", en: "Invalid", fr: "Invalide", it: "Non valida", pt: "Inválida" },
  ...
  "chat.titulo":         { es: "Tu entrenador", en: "Your coach", fr: "Ton coach", it: "Il tuo coach", pt: "O teu treinador" },
  "chat.sub":            { es: "Nutricionista y entrenador personal", en: "Nutritionist & personal trainer", fr: "Nutritionniste et coach personnel", it: "Nutrizionista e personal trainer", pt: "Nutricionista e treinador pessoal" },
  "chat.vacio_titulo":   { es: "Habla con tu entrenador", en: "Talk to your coach", fr: "Parle à ton coach", it: "Parla col tuo coach", pt: "Fala com o teu treinador" },
  "chat.vacio_sub":      { es: "Cuéntale cómo te ha ido el día, qué has comido o qué dudas tienes. Conoce tus objetivos y te dirá siempre la verdad, aunque no siempre sea lo que quieras oír.", en: "Tell them how your day went, what you ate or any questions you have. They know your goals and will always tell you the truth, even when it's not what you want to hear.", fr: "Raconte-lui ta journée, ce que tu as mangé ou tes questions. Il connaît tes objectifs et te dira toujours la vérité, même si ce n'est pas ce que tu veux entendre.", it: "Raccontagli com'è andata la giornata, cosa hai mangiato o i tuoi dubbi. Conosce i tuoi obiettivi e ti dirà sempre la verità, anche quando non è ciò che vuoi sentire.", pt: "Conta-lhe como correu o dia, o que comeste ou as tuas dúvidas. Conhece os teus objetivos e dir-te-á sempre a verdade, mesmo quando não é o que queres ouvir." },
  "chat.placeholder":    { es: "Escribe un mensaje…", en: "Type a message…", fr: "Écris un message…", it: "Scrivi un messaggio…", pt: "Escreve uma mensagem…" },
  "chat.enviar":         { es: "Enviar", en: "Send", fr: "Envoyer", it: "Invia", pt: "Enviar" },
  "chat.pensando":       { es: "Pensando…", en: "Thinking…", fr: "Réflexion…", it: "Sto pensando…", pt: "A pensar…" },
  "chat.borrar":         { es: "Borrar conversación", en: "Delete chat", fr: "Supprimer la conversation", it: "Elimina conversazione", pt: "Apagar conversa" },
  "chat.borrar_confirm": { es: "¿Borrar esta conversación? Tu entrenador seguirá recordando lo que ha aprendido de ti.", en: "Delete this conversation? Your coach will still remember what it learned about you.", fr: "Supprimer cette conversation ? Ton coach se souviendra quand même de ce qu'il a appris sur toi.", it: "Eliminare questa conversazione? Il tuo coach ricorderà comunque ciò che ha imparato su di te.", pt: "Apagar esta conversa? O teu treinador continuará a lembrar-se do que aprendeu sobre ti." },
  "chat.nueva":          { es: "Nueva conversación", en: "New conversation", fr: "Nouvelle conversation", it: "Nuova conversazione", pt: "Nova conversa" },
  "chat.vacia":          { es: "Conversación vacía", en: "Empty conversation", fr: "Conversation vide", it: "Conversazione vuota", pt: "Conversa vazia" },
  "chat.bienvenida":     { es: "Bienvenida", en: "Welcome", fr: "Bienvenue", it: "Benvenuto", pt: "Bem-vindo" },
  "chat.resumen_titulo": { es: "Resumen · {fecha}", en: "Summary · {fecha}", fr: "Résumé · {fecha}", it: "Riepilogo · {fecha}", pt: "Resumo · {fecha}" },
  "chat.sobre_dia":      { es: "Sobre tu día · {fecha}", en: "About your day · {fecha}", fr: "À propos de ta journée · {fecha}", it: "Sulla tua giornata · {fecha}", pt: "Sobre o teu dia · {fecha}" },

  // ── Notificaciones del entrenador (buzón ✉️) ──
  "buzon.titulo":        { es: "Notificaciones", en: "Notifications", fr: "Notifications", it: "Notifiche", pt: "Notificações" },
  "buzon.sub":           { es: "Los avisos y resúmenes de tu entrenador", en: "Your coach's alerts and summaries", fr: "Les alertes et résumés de ton coach", it: "Avvisi e riepiloghi del tuo coach", pt: "Os avisos e resumos do teu treinador" },
  "buzon.resumen":       { es: "Resumen de tu día", en: "Your day's summary", fr: "Résumé de ta journée", it: "Riepilogo della tua giornata", pt: "Resumo do teu dia" },
  "buzon.generando":     { es: "Tu entrenador está preparando tu resumen…", en: "Your coach is preparing your summary…", fr: "Ton coach prépare ton résumé…", it: "Il tuo coach sta preparando il riepilogo…", pt: "O teu treinador está a preparar o teu resumo…" },
  "buzon.vacio_titulo":  { es: "Sin notificaciones", en: "No notifications", fr: "Aucune notification", it: "Nessuna notifica", pt: "Sem notificações" },
  "buzon.vacio_sub":     { es: "Aquí aparecerán los resúmenes diarios de tu entrenador. Actívalos en Ajustes → Notificaciones.", en: "Your coach's daily summaries will appear here. Turn them on in Settings → Notifications.", fr: "Les résumés quotidiens de ton coach apparaîtront ici. Active-les dans Réglages → Notifications.", it: "Qui appariranno i riepiloghi giornalieri del tuo coach. Attivali in Impostazioni → Notifiche.", pt: "Aqui aparecerão os resumos diários do teu treinador. Ativa-os em Definições → Notificações." },
  "buzon.hablar":        { es: "Hablar con tu entrenador sobre el día", en: "Talk to your coach about this day", fr: "Parler de cette journée avec ton coach", it: "Parla col tuo coach di questa giornata", pt: "Fala com o teu treinador sobre este dia" },
  "buzon.borrar":        { es: "Borrar", en: "Delete", fr: "Supprimer", it: "Elimina", pt: "Apagar" },
  "buzon.borrar_confirm":{ es: "¿Borrar este resumen?", en: "Delete this summary?", fr: "Supprimer ce résumé ?", it: "Eliminare questo riepilogo?", pt: "Apagar este resumo?" },

  // ── Menú lateral (hamburguesa) ──
  "menu.titulo":     { es: "Menú", en: "Menu", fr: "Menu", it: "Menu", pt: "Menu" },
  "menu.cerrar":     { es: "Cerrar menú", en: "Close menu", fr: "Fermer le menu", it: "Chiudi menu", pt: "Fechar menu" },
  "menu.chat":       { es: "Tu entrenador", en: "Your coach", fr: "Ton coach", it: "Il tuo coach", pt: "O teu treinador" },
  "menu.chat.sub":   { es: "Habla con tu nutricionista y entrenador", en: "Chat with your nutritionist & coach", fr: "Discute avec ton nutritionniste et coach", it: "Parla col tuo nutrizionista e coach", pt: "Fala com o teu nutricionista e treinador" },
  "menu.ia":         { es: "Configurar IA", en: "AI settings", fr: "Configurer l'IA", it: "Configura IA", pt: "Configurar IA" },
  "menu.ia.sub":     { es: "Tus claves de Gemini y el modelo", en: "Your Gemini keys and model", fr: "Tes clés Gemini et le modèle", it: "Le tue chiavi Gemini e il modello", pt: "As tuas chaves Gemini e o modelo" },
  "menu.frecuentes":    { es: "Comidas frecuentes", en: "Frequent meals", fr: "Repas fréquents", it: "Pasti frequenti", pt: "Refeições frequentes" },
  "menu.frecuentes.sub":{ es: "Tu desayuno, comida… de siempre, en automático", en: "Your usual breakfast, lunch… on autopilot", fr: "Ton petit-déj, déjeuner… en automatique", it: "La tua colazione, pranzo… in automatico", pt: "O teu pequeno-almoço, almoço… em automático" },
  "menu.ajustes":    { es: "Ajustes", en: "Settings", fr: "Réglages", it: "Impostazioni", pt: "Definições" },
  "menu.ajustes.sub":{ es: "Idioma, notificaciones, icono y más", en: "Language, notifications, icon and more", fr: "Langue, notifications, icône et plus", it: "Lingua, notifiche, icona e altro", pt: "Idioma, notificações, ícone e mais" },

  // ── Onboarding: preparando el entrenador ──
  "preparando.titulo":       { es: "Preparando tu entrenador personal…", en: "Setting up your personal coach…", fr: "Préparation de ton coach personnel…", it: "Sto preparando il tuo coach personale…", pt: "A preparar o teu treinador pessoal…" },
  "preparando.sub":          { es: "Estoy configurando tu asesor con tu perfil para darte consejos personalizados desde el primer día. Por favor, espera.", en: "I'm setting up your advisor with your profile so it can give you personalised advice from day one. Please wait.", fr: "Je configure ton conseiller avec ton profil pour te donner des conseils personnalisés dès le premier jour. Patiente un instant.", it: "Sto configurando il tuo consulente con il tuo profilo per darti consigli personalizzati fin dal primo giorno. Attendi un momento.", pt: "Estou a configurar o teu conselheiro com o teu perfil para te dar conselhos personalizados desde o primeiro dia. Aguarda um momento." },
  "preparando.listo_titulo": { es: "¡Listo!", en: "All set!", fr: "C'est prêt !", it: "Fatto!", pt: "Pronto!" },
  "preparando.listo_sub":    { es: "Tu entrenador ya está configurado con tu perfil. Recuerda que siempre te hablará con la verdad. Puedes continuar.", en: "Your coach is now set up with your profile. Remember, it will always tell you the truth. You can continue.", fr: "Ton coach est maintenant configuré avec ton profil. Souviens-toi qu'il te dira toujours la vérité. Tu peux continuer.", it: "Il tuo coach è ora configurato con il tuo profilo. Ricorda che ti dirà sempre la verità. Puoi continuare.", pt: "O teu treinador já está configurado com o teu perfil. Lembra-te de que te dirá sempre a verdade. Podes continuar." },
  "preparando.error_sub":    { es: "No he podido preparar tu entrenador ahora mismo, pero no pasa nada: irá aprendiendo de ti con el uso. Puedes continuar.", en: "I couldn't set up your coach right now, but that's okay: it will learn about you as you use it. You can continue.", fr: "Je n'ai pas pu préparer ton coach pour l'instant, mais ce n'est pas grave : il apprendra à te connaître à l'usage. Tu peux continuer.", it: "Non sono riuscito a preparare il tuo coach adesso, ma non c'è problema: imparerà a conoscerti con l'uso. Puoi continuare.", pt: "Não consegui preparar o teu treinador agora, mas não faz mal: vai aprender contigo com o uso. Podes continuar." },
  "preparando.continuar":    { es: "Continuar", en: "Continue", fr: "Continuer", it: "Continua", pt: "Continuar" },
  "preparando.espera":       { es: "Espera un momento…", en: "Just a moment…", fr: "Un instant…", it: "Un momento…", pt: "Um momento…" },
  ...
  "err.modelo_incompatible":{ es: "El modelo no aceptó la petición. Ve a Ajustes → Conectar IA y elige otro modelo (p. ej. Gemini 3.6 Flash).", en: "The model rejected the request. Go to Settings → Connect AI and pick another model (e.g. Gemini 3.6 Flash).", fr: "Le modèle a refusé la requête. Va dans Réglages → Connecter l'IA et choisis un autre modèle (p. ex. Gemini 3.6 Flash).", it: "Il modello ha rifiutato la richiesta. Vai in Impostazioni → Connetti IA e scegli un altro modello (es. Gemini 3.6 Flash).", pt: "O modelo rejeitou o pedido. Vai a Definições → Ligar IA e escolhe outro modelo (p. ex. Gemini 3.6 Flash)." },
  ...
  "err.modelos_saturados": { es: "Los modelos de IA tienen mucha demanda ahora mismo. Inténtalo de nuevo en unos minutos.", en: "The AI models are under heavy demand right now. Try again in a few minutes.", fr: "Les modèles d'IA sont très sollicités en ce moment. Réessaie dans quelques minutes.", it: "I modelli di IA hanno molta richiesta in questo momento. Riprova tra qualche minuto.", pt: "Os modelos de IA estão com muita procura agora. Tenta de novo dentro de alguns minutos." },
  ...
  "err.todas_agotadas":    { es: "Todas tus claves se han quedado sin tokens por ahora. Añade otra clave en Ajustes o espera a que se reinicie la cuota.", en: "All your keys are out of tokens for now. Add another key in Settings or wait for the quota to reset.", fr: "Toutes tes clés sont à court de jetons pour l'instant. Ajoute une autre clé dans Réglages ou attends la réinitialisation du quota.", it: "Tutte le tue chiavi sono senza token per ora. Aggiungi un'altra chiave in Impostazioni o aspetta il ripristino della quota.", pt: "Todas as tuas chaves ficaram sem tokens por agora. Adiciona outra chave em Definições ou espera que a quota reinicie." },
