...
**👉 [Descargar el APK para Android](https://github.com/l0p3z26/NutriAI/releases/latest/download/NutriAI-1.5.2.apk)** — instálalo permitiendo "orígenes desconocidos".
...
| Versión | Descarga |
|---|---|
| **1.5.2** (última) | [NutriAI-1.5.2.apk](https://github.com/l0p3z26/NutriAI/releases/download/v1.5.2/NutriAI-1.5.2.apk) |
| 1.0.0 (primera versión) | [NutriAI-1.0.0.apk](https://github.com/l0p3z26/NutriAI/releases/download/v1.0.0/NutriAI-1.0.0.apk) |

Las versiones intermedias (1.1.0–1.5.1) fueron builds internos de desarrollo o ya reemplazadas; su evolución completa está en el **Historial de Versiones** dentro de la app.
